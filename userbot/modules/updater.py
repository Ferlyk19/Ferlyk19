    ...
    if HEROKU_API_KEY is not None:
        ...
        if HEROKU_APP_NAME is None:
            await event.edit(
                ...
                ' untuk dapat deploy perubahan terbaru dari ⚡Ferly-Project⚡.`'
            )
            repo.__del__()
            return
        ...
        await event.edit('`[HEROKU]:'
                         '\nSedang MengUpdate ⚡Ferly-ProjectBot⚡, Mohon Menunggu 5-7 Menit`'
                         )
        ups_rem.fetch(ac_br)
        ...
        if build.status == "failed":
            ...
            await event.edit("`Ferly-ProjectBot Berhasil Di Deploy!\n" "Restarting, Mohon Tunggu Sebentar.....`")
...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit('**⚡Ferly-Project⚡** `Berhasil Di Update!`')
    await asyncio.sleep(1)
    await event.edit('**⚡Ferly-Project⚡** `Di Restart....`')
    await asyncio.sleep(1)
    ...
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID, "#BOT \n"
            "**⚡Ferly-Project⚡ Telah Di Perbarui.**")
...
async def upstream(event):
    ...
    if changelog == '' and force_update is False:
        await event.edit(
            f'\n⚡Ferly-Project⚡ Sudah Versi Terbaru\n')
        await asyncio.sleep(15)
        await event.delete()
        return repo.__del__()

    if conf is None and force_update is False:
        changelog_str = f'**Pembaruan Untuk ⚡Ferly-Project⚡ :\n\n💻 Pembaruan Data :**\n`{changelog}`'
    ...
    if force_update:
        ...
        await event.edit('` Proses Update ⚡Ferly-Project, Loading....1%`')
        await event.edit('` Proses Update ⚡Ferly-Project, Loading....20%`')
        await event.edit('` Proses Update ⚡Ferly-Project, Loading....35%`')
        await event.edit('` Proses Update ⚡Ferly-Project, Loading....77%`')
        await event.edit('` Proses Update ⚡Ferly-Project, Updating...90%`')
        await event.edit('` Proses Update ⚡Ferly-Project, Mohon Tunggu Sebentar....100%`')
    if conf == "now":
